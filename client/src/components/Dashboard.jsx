                        ...
                        <div className="flex-grow bg-slate-950 p-4 overflow-hidden flex items-center justify-center relative min-h-[400px]">
                            {liveFrame ? (
                                <div className="relative w-full h-full">
                                    ...
                                    <div className="absolute top-4 right-4 bg-primary-600/20 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-black flex items-center gap-1 border border-primary-500/30">
                                        <Monitor size={12} className="text-primary-400" />
                                        <span className="text-primary-200">UZAK OTURUM AKTİF</span>
                                    </div>
                                </div>
                        ...
                        <div className="w-full md:w-[420px] p-8 md:p-12 flex flex-col border-l border-slate-800 bg-slate-900/50 relative">
                            ...
                            >
                                {actionLoading === focusSite.id ? (
                                    ...
                                    <>SİTEYİ PENCEREDE AÇ <Lock size={20} /></>
                                )}
                            </button>
                            <div className="mt-4">
